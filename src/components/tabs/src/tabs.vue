<template>
    <div class="tabs row">
        ...
        <div ref="scroller" class="tabs-scroller row">
            <slot></slot>
        </div>
...
const scrollNavigationSpeed = 5 // in pixels
...
export default {
    ...
    methods: {
        ...
        __scrollToSelectedIfNeeded(tab) {
            ...
            let contentRect = this.$refs.scroller.getBoundingClientRect()
            let tabRect = tab.getBoundingClientRect()
            let tabWidth = tabRect.width
            let offset = tabRect.left - contentRect.left
        ...
        __scrollTowards(value) {
            let scrollPosition = this.$refs.scroller.scrollLeft
            let direction = value < scrollPosition ? -1 : 1
            let done = false
